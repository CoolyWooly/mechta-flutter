...
@JsonKey(name: 'averageRating') double? get averageRating;@JsonKey(name: 'reviewsCount') int? get reviewsCount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RatingModel&&(identical(other.averageRating, averageRating) || other.averageRating == averageRating)&&(identical(other.reviewsCount, reviewsCount) || other.reviewsCount == reviewsCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,averageRating,reviewsCount);

@override
String toString() {
  return 'RatingModel(averageRating: $averageRating, reviewsCount: $reviewsCount)';
}
...
@useResult
$Res call({
@JsonKey(name: 'averageRating') double? averageRating,@JsonKey(name: 'reviewsCount') int? reviewsCount
});
...
/// Create a copy of RatingModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? averageRating = freezed,Object? reviewsCount = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'averageRating')  double? averageRating, @JsonKey(name: 'reviewsCount')  int? reviewsCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RatingModel() when $default != null:
return $default(_that.averageRating,_that.reviewsCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'averageRating')  double? averageRating, @JsonKey(name: 'reviewsCount')  int? reviewsCount)  $default,) {final _that = this;
switch (_that) {
case _RatingModel():
return $default(_that.averageRating,_that.reviewsCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'averageRating')  double? averageRating, @JsonKey(name: 'reviewsCount')  int? reviewsCount)?  $default,) {final _that = this;
switch (_that) {
case _RatingModel() when $default != null:
return $default(_that.averageRating,_that.reviewsCount);case _:
  return null;
...
class _RatingModel extends RatingModel {
  const _RatingModel({@JsonKey(name: 'averageRating') this.averageRating, @JsonKey(name: 'reviewsCount') this.reviewsCount}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RatingModel&&(identical(other.averageRating, averageRating) || other.averageRating == averageRating)&&(identical(other.reviewsCount, reviewsCount) || other.reviewsCount == reviewsCount));
}
...
/// Create a copy of RatingModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? averageRating = freezed,Object? reviewsCount = freezed,}) {
