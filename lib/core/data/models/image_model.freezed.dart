...
@JsonKey(name: 'dark') String? get dark;@JsonKey(name: 'light') String? get light;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ImageModel&&(identical(other.dark, dark) || other.dark == dark)&&(identical(other.light, light) || other.light == light));
}
...
@override
String toString() {
  return 'ImageModel(dark: $dark, light: $light)';
}
...
@useResult
$Res call({
@JsonKey(name: 'dark') String? dark,@JsonKey(name: 'light') String? light
});
...
as String?,light: freezed == light ? _self.light : light // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'dark')  String? dark, @JsonKey(name: 'light')  String? light)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ImageModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'dark')  String? dark, @JsonKey(name: 'light')  String? light)  $default,) {final _that = this;
switch (_that) {
case _ImageModel():
return $default(_that.dark,_that.light);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'dark')  String? dark, @JsonKey(name: 'light')  String? light)?  $default,) {final _that = this;
switch (_that) {
case _ImageModel() when $default != null:
return $default(_that.dark,_that.light);case _:
  return null;
...
class _ImageModel extends ImageModel {
  const _ImageModel({@JsonKey(name: 'dark') this.dark, @JsonKey(name: 'light') this.light}): super._();
  factory _ImageModel.fromJson(Map<String, dynamic> json) => _$ImageModelFromJson(json);

@override@JsonKey(name: 'dark') final  String? dark;
@override@JsonKey(name: 'light') final  String? light;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ImageModel&&(identical(other.dark, dark) || other.dark == dark)&&(identical(other.light, light) || other.light == light));
}
